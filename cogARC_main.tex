...
\chapter{Design process}
	...
	\section{Requirements}
		...
		\input{includes/cogARC_requirements}

	\section{User experience goals}
		\label{sec:user_experience_goals}
		\input{includes/cogARC_user_experience_goals}

	\section{Usability goals}
		\label{sec:usability_goals}
		\input{includes/cogARC_usability_goals}
...
%		\input{includes/cogARC_development_process}
	...
	\section{Editor data}
		...
		\input{includes/cogARC_editor_data}
...
\includepdf{includes/AR_project}
...
\includepdf[pages=-]{includes/DESIGN_DOCUMENT_v2.pdf}
...
\includepdf[pages=-]{includes/Project_plan}
...
\includepdf[pages=-]{includes/Project_agreement}
...
\includepdf[pages=1]{includes/summary-report_toggl}

\addtocounter{section}{1}
\addcontentsline{toc}{section}{Detailed report}
\includepdf[pages=-]{includes/detailed-report_toggl}
...
\includepdf[pages=-]{includes/git_log_unityproject}
