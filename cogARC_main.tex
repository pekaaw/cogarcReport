...
% \usepackage{etoolbox}
% \makeatletter
% \patchcmd{\chapter}{\if@openright\let\cleardoublepage\relax\else\let\clearpage\relax\fi}{}{}{}
% \makeatother
...
% 	{\thechapter}			% label
% 	{0.5ex}			% separation
% 	{\let\clearpage\relax}			% before-code
% 	{}			% after-code
% \titleformat
% 	{\chapter}	% command
% 	[block]		% shape
% 	{\let\clearpage\relax\center\bfseries\Large}			% format
% 	{\thechapter}			% label
% 	{0ex}			% separation
% 	{}			% before-code
% 	{}			% after-code
