...
avoided, we think we should. This reduces relieves the user from potentially many
...
design document specified the creation of towers andBecause of this we thought that the input we
got was convenient
