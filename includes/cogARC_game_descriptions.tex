...
% 	\centering
% 	\vspace{-10pt}
% 	\includegraphics[width=0.28\textwidth]{images/Costas/game_mockup1(matching).jpg}
% 	\vspace{-10pt}
% 	\caption{Shape Match}
...
\subsection{Colour Match}
	...
	% 	\centering
	% 	\vspace{-10pt}
	% 	\includegraphics[width=0.28\textwidth]{images/Costas/game_mockup1(matching2).jpg}
	% 	\vspace{-10pt}
...
\subsection{Total Sum}
	...
	% 	\centering
	% 	% \vspace{-10pt}
	% 	\includegraphics[width=0.28\textwidth]{images/Costas/game_mockup2(arithmetic).jpg}
	% 	\vspace{-10pt}
	% 	\caption{Total Sum}
