...
The project is built using Unity as the driving game engine and Vuforia for Augmented Reality capabilities. The mini games are programmed in MonoDevelop using Unity JavaScript.
...
\subchapter{Level Creator}%Tror jeg?
